...
from jobintelengine.exception import NaukriException
from jobintelengine.naukri.constant import headers as naukri_headers
from jobintelengine.naukri.util import (
    is_job_remote,
    parse_job_type,
